...
public class Loader {
     ...
     * @return return Certificate, other throw a UtilException
     */
    ...
    /**
     * Load the jks certificate from file 
     * @param path The path to jks file in resource
     * @param password The password of jks file
     * @return return Certificate, other throw a UtilException
     */
    public static KeyStore LoadJksResource(String path, String password) throws UtilException {
        try {
            KeyStore keyStore = KeyStore.getInstance(KEYSTORE_JKS);
     ...
     * @param path The path to p12 file in resource
